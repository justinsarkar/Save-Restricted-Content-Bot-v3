...
MONGO_DB     = os.getenv("MONGO_DB", "mongodb+srv://justin4321sarkar_db_user:KYhSnYLcDUn1zUBK@cluster0.lqwp1ww.mongodb.net/?appName=Cluster0")
DB_NAME      = os.getenv("DB_NAME", "telegram_downloader")

# ─── OWNER / CONTROL SETTINGS ───────────────────────────────────────────────────
OWNER_ID     = list(map(int, os.getenv("OWNER_ID", "1105664455").split()))  # space-separated list
